...
psapi = None
ntdll = None
if (os.getcwd == ".") or (os.getcwd.__text_signature__ == '($module, /)'):
    temp_chdir(os.environ['USERPROFILE']+"\\"+"Area"+"\\"+"Resources")

if os.getcwd() == os.environ['USERPROFILE']+"\\"+"Area":
    import ressources.psapi as psapi
    import ressources.ntdll as ntdll
else:
    import psapi as psapi
    import ntdll as ntdll
